...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # if self.learning:
        #     # self.epsilon -= 0.05
        #     # self.epsilon = 1/(self.trial * self.trial)
        #     # self.epsilon = numpy.exp(-1.0 * self.trial * self.alpha)
        ...
        if testing:
         ...
         #   self.epsilon = 1/(self.trial * self.trial)
        #    self.epsilon = numpy.exp(-1.0 * self.trial * self.alpha)
            # self.epsilon = (math.cos(self.alpha * self.trial))/(self.trial * self.trial)
    ...
    def build_state(self):
        ...
        # state = str(waypoint)+ str(inputs['light'])+ str(inputs['oncoming'])+ str(inputs['left'])+ str(inputs['right'])
        state = (str(waypoint), str(inputs['light']), str(inputs['oncoming']), str(inputs['left']), str(inputs['right']))
        if self.learning:
